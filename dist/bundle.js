...
var _Thumbs = __webpack_require__(/*! ./Thumbs */ "./src/components/Thumbs.js");

var _Thumbs2 = _interopRequireDefault(_Thumbs);

var _Info = __webpack_require__(/*! ./Info */ "./src/components/Info.js");
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.receiveQuery = _this.receiveQuery.bind(_this);
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      var weatherUrl = 'https://api.openweathermap.org/data/2.5/weather?q=' + this.state.search + '&apiKey=ba952ac5bba8a3501d9f27b84a1e7ed6';

      fetch(weatherUrl).then(function (response) {
        return response.json();
      }).then(function (content) {
        return content.weather[0].description;
      }).then(function (weather) {
        var unsplashUrl = 'https://api.unsplash.com/search/photos?page=1&query=' + weather + '&client_id=b86a7bedd1b8ec0a69b8569aa17c9b1fa7c8377200e6c71c99d09e92da2c1a0d';
    ...
    key: 'receiveQuery',
    value: function receiveQuery(query) {
      var _this4 = this;

      this.setState({
        search: query
      }, function () {
        return _this4.apiCall();
      });
    }
  }, {
    key: 'receiveImage',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'figure',
          { className: 'photo', id: 'photo' },
          _react2.default.createElement('img', { src: this.state.mainImage })
        ),
        _react2.default.createElement(_Info2.default, { creditsName: this.state.creditsName, creditsPortfolioHTML: this.state.creditsPortfolioHTML }),
        _react2.default.createElement(_Thumbs2.default, { images: this.state.images, receiveImage: this.receiveImage }),
        _react2.default.createElement(_Search2.default, { receiveQuery: this.receiveQuery })
      );
    }
  }]);
...
var Thumbs = function (_React$Component) {
  ...
  function Thumbs() {
    ...
    return _possibleConstructorReturn(this, (Thumbs.__proto__ || Object.getPrototypeOf(Thumbs)).apply(this, arguments));
  }
  ...
  _createClass(Thumbs, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "info" },
        _react2.default.createElement("p", { className: "info__item info__item--conditions", id: "conditions" }),
        _react2.default.createElement(
          "p",
          { className: "info__item info__item--credits" },
          _react2.default.createElement(
            "a",
            { href: this.props.creditsPortfolioHTML, id: "credit-user" },
            this.props.creditsName
          ),
          _react2.default.createElement(
            "span",
            null,
          ...
          _react2.default.createElement(
            "a",
            { href: this.props.creditsPortfolioHTML, id: "credit-platform" },
            "Unsplash"
          )
        )
      );
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "form",
          { onSubmit: this.handleSubmit, className: "search", id: "search" },
          _react2.default.createElement(
            "label",
            { className: "search__label", htmlFor: "search-tf" },
            "City"
          ),
          _react2.default.createElement("input", { onChange: this.handleChange, className: "search__input", id: "search-tf", name: "city", placeholder: "Enter city name", autoComplete: "city", value: this.state.searchQuery }),
          _react2.default.createElement(
            "button",
...
var Thumb = function (_React$Component) {
  ...
  _createClass(Thumb, [{
    ...
    key: "render",
    value: function render() {
      return _react2.default.createElement("img", { onClick: this.handleClick, src: this.props.imageItem.urls.thumb, className: "thumb" });
    }
  }]);
...
var Thumbs = function (_React$Component) {
  ...
  function Thumbs() {
    ...
    return _possibleConstructorReturn(this, (Thumbs.__proto__ || Object.getPrototypeOf(Thumbs)).call(this));
    // this.state = {};
  }
  ...
  _createClass(Thumbs, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'thumbs', id: 'thumbs' },
        this.props.images.map(function (image) {
          return _react2.default.createElement(_Thumb2.default, { key: image.id, imageItem: image, receiveImage: _this2.props.receiveImage });
        })
      );
    }
  }]);
